...
<div >
  {/* <img src='/home.jpg'/> */}
  <Image src="/home.jpg" width={2200} height={744} className='z-1000' style={{zIndex:-1}}></Image>
</div>
<section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear the code with the codeswear.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the whatever you want? what do you want ?so why not wear the code ?</p>
    </div>
