      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <Image alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto  object-cover object-top px-24 rounded " src="/home.jpg" height={400} width={400} />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                onClick={()=>{addToCart(slug,1,499,"Wear the Code","X-XL","Red")}}>Add to Cart</button>
              ...
              <div className="flex pin mt-6 space-x-2 text-sm">
                <input type="text" className='border-2 border-gray-400 rounded-md' onChange={onChangepin} />
                <button className=' ml-14 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded' onClick={checkServiceability}>Check</button>
              </div>
              {Services && Services!==null && <div className="text-green-700 text-sm mt-3">
                yey! This picode is serviceble
              </div>}
